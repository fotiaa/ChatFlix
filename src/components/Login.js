  ...
  return (
    <div>
      ...
      <form className = 'w-3/12 absolute bg-black p-12 my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80'>
        ...
        <input types="text" placeholder="Email address" className = "p-4 my-4 w-full bg-gray-700"/>
        {!isSignInForm && <input types="text" placeholder="Full Name" className = "p-4 my-4 w-full bg-gray-700"/>}
        <input types="password" placeholder="password" className = "p-4 my-4 w-full bg-gray-700"/>
